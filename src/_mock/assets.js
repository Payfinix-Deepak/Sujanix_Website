...
export const _postTitles = [
  ...
  'AI In ECommerce: Shaping The Future Of Customer Engagement',
...
export const _descriptions = [
  `Note that this free trial offer is only available to new customers who have never utilized Xeady's services yet but now new to excellency and outstanding performance. To be eligible for the free trial, customers must meet Xeady's eligibility rules, which may include geographical restrictions or other requirements.`,
  `There is a one-week trial period available at no cost. This period, which begins when the trial account is activated, automatically ends at the conclusion of the allotted time. It is important to remember that the duration of the free trial could change depending on the specific promotion or deal.`,
  `The free trial offer may be subject to certain limits or limitations, notwithstanding the company's best efforts to provide a comprehensive trial experience. These limitations may take the form of usage caps, access restrictions to specific features or functionalities, or other restrictions mentioned in the offer specifics.`,
